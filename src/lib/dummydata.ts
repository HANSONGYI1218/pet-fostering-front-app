...
export const dummyFosterAnimals: FosterListAnimalItem[] = [
  {
    ...
    animal_personalitys: [
      ANIMAL_PERSONALITYS.GOOD_WITH_OTHER_ANIMAL,
      ANIMAL_PERSONALITYS.INDEPENDENCE,
    ],
    foster_environments: [
...
export const dummyOgrainzationAnimals: OgrainzationAnimalListItem[] = [
  ...
  },
  {
    ...
    animal_healths: [ANIMAL_HEALTH.NEUTERED, ANIMAL_HEALTH.VACCINATED],
    animal_personalitys: [
      ANIMAL_PERSONALITYS.POTTY_TRAINING_COMPLETION,
      ANIMAL_PERSONALITYS.ENERGETIC,
      ANIMAL_PERSONALITYS.NO_BITING,
    ],
    foster_environments: [
      ANIMAL_ENVIRONMENT.HOUSEHOLD_WITH_YOUNG_CHILDREN,
      ANIMAL_ENVIRONMENT.CARE_FOR_SENSITIVE_OR_FEARFUL_PETS,
  ...
  },
  {
    ...
    animal_personalitys: [
      ANIMAL_PERSONALITYS.GOOD_WITH_OTHER_ANIMAL,
      ANIMAL_PERSONALITYS.SENSITIVITY,
    ],
    foster_environments: [
      ANIMAL_ENVIRONMENT.FREQUENT_INTERACTION_WITH_PETS,
      ANIMAL_ENVIRONMENT.PRESENCE_OF_OTHER_ANIMAL,
  ...
  },
  {
    ...
    animal_healths: [ANIMAL_HEALTH.NEUTERED, ANIMAL_HEALTH.VACCINATED],
    animal_personalitys: [
      ANIMAL_PERSONALITYS.FRIENDLY_WITH_PEOPLE,
      ANIMAL_PERSONALITYS.POTTY_TRAINING_COMPLETION,
      ANIMAL_PERSONALITYS.QUIET,
    ],
    foster_environments: [
...
export const dummyOgrainzationAnimalDetails: FosterAnimalDetailItem[] = [
  {
    id: '10',
    name: 'Yuna',
    type: AnimalType.CAT,
    ...
    special_notes_animals: [
      ANIMAL_SPECIAL_NOTES.DISABLED_OR_ILL_PETS_ACCEPTED,
      ANIMAL_SPECIAL_NOTES.POTTY_ACCIDENTS,
      ANIMAL_SPECIAL_NOTES.ONGOING_TREATMENT_OR_RECOVERY,
    ],
    isEmergency: true,
    organization: {
      id: '5',
  ...
  },
  {
    ...
    special_notes_animals: [
      ANIMAL_SPECIAL_NOTES.AGGRESSION_TOWARD_OTHER_ANIMALS,
    ],
    isEmergency: true,
    organization: {
      id: '6',
  ...
  },
  {
    ...
    special_notes_animals: [ANIMAL_SPECIAL_NOTES.ONGOING_TREATMENT_OR_RECOVERY],
    isEmergency: true,
    organization: {
      id: '8',
      name: '하늘 보호소',
  ...
  },
  {
    ...
    foster_environments: [ANIMAL_ENVIRONMENT.FREQUENT_INTERACTION_WITH_PETS],
    special_notes_animals: [
      ANIMAL_SPECIAL_NOTES.AGGRESSION_TOWARD_OTHER_ANIMALS,
    ],
    isEmergency: false,
  ...
  },
  {
    ...
    isBookmarked: false,
    animal_healths: [ANIMAL_HEALTH.NEUTERED, ANIMAL_HEALTH.VACCINATED],
    animal_personalitys: [ANIMAL_PERSONALITYS.ENERGETIC],
    foster_environments: [ANIMAL_ENVIRONMENT.FREQUENT_INTERACTION_WITH_PETS],
    special_notes_animals: [ANIMAL_SPECIAL_NOTES.MEDICATION_REQUIRED],
    isEmergency: true,
    organization: {
      id: '11',
      name: '푸른 보호소',
  ...
  },
  {
    ...
    foster_environments: [ANIMAL_ENVIRONMENT.PRESENCE_OF_OTHER_ANIMAL],
    special_notes_animals: [
      ANIMAL_SPECIAL_NOTES.AGGRESSION_TOWARD_OTHER_ANIMALS,
      ANIMAL_SPECIAL_NOTES.MEDICATION_REQUIRED,
    ],
    isEmergency: false,
    organization: {
      id: '12',
  ...
  },
  {
    ...
    foster_environments: [ANIMAL_ENVIRONMENT.QUIET_ENVIRONMENT],
    special_notes_animals: [ANIMAL_SPECIAL_NOTES.POTTY_ACCIDENTS],
    isEmergency: true,
    organization: {
      id: '13',
