...
export const ANIMAL_STATUS_LABEL_KO: Record<AnimalStatus, string> = {
  [AnimalStatus.WAITING]: '임시보호 전',
  [AnimalStatus.IN_PROGRESS]: '임시보호 중',
  [AnimalStatus.COMPLETED]: '임시보호 완료',
};
