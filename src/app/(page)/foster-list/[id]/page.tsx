...
export default async function FosterListDetailPage({
  ...
  const animalDatas = [
    ...
    {
      title: '접종 여부',
      data: animal?.animal_healths.find((a) => a === '접종완료')
        ? '완료'
        : '미완료',
    },
    {
      title: '건강 상태',
      data: animal?.animal_healths.find((a) => a === '양호')
        ? '양호'
        : '미양호',
    },
    {
      title: '중성화',
      data: animal?.animal_healths.find((a) => a === '중성화')
        ? '완료'
        : '미완료',
    },
  ];
            ...
            <div className="flex w-full flex-col gap-10">
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="flex h-[60px] flex-wrap gap-6 overflow-hidden">
                  {animal?.special_notes_animal?.map((note, index) => {
                    return (
                      <Badge
                        key={index}
                        variant={'destructive'}
